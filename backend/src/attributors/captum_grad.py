...
class CaptumGradientsAttributor(BaseAttributor):
    ...
    This class supports text classification, autoregressive text generation, and image
    classification models. It acts as a dynamic dispatcher: depending on the injected
    Wrapper type, it adapts the forward function and the attribution process to handle
    single-pass classification (text or image) or step-by-step token generation.
    """
    ...
    # =========================================================
    # 0. IMAGE CLASSIFICATION (Pixel-space IG)
    # =========================================================
    def _attribute_image_classification(self, input_data: Any, target_output: Optional[int]) -> AttributionOutput:
        """Performs Integrated Gradients attribution directly on pixel values.
