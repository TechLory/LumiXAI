...
## Tests
#### Demo text-to-text attribution:
![demo text](/readme_files/demo_text-to-text.gif)
#### Demo text-to-image attribution:
![demo image](/readme_files/demo_1_token-pixel_attribution_gui.gif)
